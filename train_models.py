...
parser.add_argument('--save_dir', default='../../imagenet/COMPNET_CHECKPOINTS', help='Path store checkpoints')
parser.add_argument('--comet_name', default='compnet', help='Path store checkpoints')
...
if __name__ == '__main__':
    ...
    model = CompNet(args.dataset_dir, args.save_dir, args.batch_size, logger)
    if(args.checkpoint):
        if(args.gpus==0):
